 ...
 const router = useRouter()
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="bg-white backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 transform transition-all duration-300 hover:shadow-indigo-200/50">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">Join Checkerist and start your journey</p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 text-gray-700 rounded-xl border ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3 text-gray-700 rounded-xl border ${
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-12 py-3 text-gray-700 rounded-xl border ${
        ...
        <p className="mt-6 text-center text-sm text-gray-600">
          ...
          <a href="/sign-in" className="font-medium text-indigo-600 hover:text-indigo-700 transition-colors">
            Sign in
          </a>
        </p>
      </div>
