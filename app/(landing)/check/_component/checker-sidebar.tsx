      ...
      <div className="bg-white rounded-lg p-6 shadow-sm">
        ...
        <div className="grid grid-cols-2 gap-2">
          {[1, 2, 3, 4, 5].map((rating) => (
            <button
              key={rating}
              className="flex items-center justify-center py-2 px-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors duration-200"
            >
