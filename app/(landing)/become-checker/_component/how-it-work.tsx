...
const HowItWorksSection = () => {
  ...
  const steps = [
    ...
    },
    {
      ...
      icon: Calendar,
      no: "03",
      title: "VIP Waiting List",
      description: "Wait for the official launch to join over 5,000 travelers worried about scams and earn money by checking their accommodations for safe travels",
      color: "bg-purple-500",
      iconBg: "bg-purple-50",
